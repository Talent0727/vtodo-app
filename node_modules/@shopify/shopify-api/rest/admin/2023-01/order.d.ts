...
export declare class Order extends Base {
    ...
    static all({ session, ids, limit, since_id, created_at_min, created_at_max, updated_at_min, updated_at_max, processed_at_min, processed_at_max, attribution_app_id, status, financial_status, fulfillment_status, fields, ...otherArgs }: AllArgs): Promise<Order[]>;
